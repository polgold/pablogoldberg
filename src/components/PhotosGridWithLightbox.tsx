          ...
          <li key={i} className="relative aspect-square overflow-hidden bg-white/5">
            ...
            >
              <Image
                ...
                unoptimized={item.thumbUrl.includes("supabase") || item.thumbUrl.includes("/api/proxy-image") || item.thumbUrl.includes("/uploads/")}
                onError={(e) => {
        ...
        >
          ...
          <div className="relative h-[85vh] w-full max-w-5xl">
            <Image
              ...
              sizes="90vw"
              unoptimized={items[index].largeUrl.includes("supabase") || items[index].largeUrl.includes("/api/proxy-image") || items[index].largeUrl.includes("/uploads/")}
              onError={(e) => {
                const img = e.currentTarget as HTMLImageElement;
