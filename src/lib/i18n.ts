...
> = {
  es: {
    ...
    workDetail: { gallery: "Galería", galleryStills: "Galería / Stills", reelsTrailers: "Reels y trailers", links: "Enlaces", credits: "Créditos", viewAll: "Ver todos", viewProject: "Ver proyecto", navLabel: "Navegación entre proyectos", moreProjects: "Más proyectos" },
    ...
    home: {
      ...
      role: "Director, Productor, Director de fotografía",
      workTitle: "Proyectos",
      reel: "Reel",
      ...
      heroSub: "Director de Sun Factory. Productor y director de fotografía en Accerts Productions. Más de 20 años desarrollando piezas con una mirada clara según cada proyecto.",
      ctaPrimary: "Ver reel",
      ctaSecondary: "Comenzar un proyecto",
      aboutText: "Director de Sun Factory. Productor y DF en Accerts Productions. Más de 20 años en cine documental y contenido comercial para agencias y empresas, con una mirada clara y un enfoque específico según cada proyecto.",
  ...
  en: {
    ...
    workDetail: { gallery: "Gallery", galleryStills: "Gallery / Stills", reelsTrailers: "Reels & Trailers", links: "Links", credits: "Credits", viewAll: "View all", viewProject: "View project", navLabel: "Project navigation", moreProjects: "More Projects" },
    ...
    home: {
      ...
      heroSub: "Director at Sun Factory. Producer and cinematographer at Accerts Productions. Over 20 years developing pieces with a clear vision for each project.",
      ctaPrimary: "Watch Reel",
      ctaSecondary: "Start a Project",
      aboutText: "Director at Sun Factory. Producer and DP at Accerts Productions. Over 20 years in documentary film and commercial content for agencies and companies, with a clear vision and a specific approach for each project.",
