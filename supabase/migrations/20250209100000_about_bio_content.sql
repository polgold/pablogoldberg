-- Bio recuperada del WordPress (pablogoldberg.com). Solo texto de presentación, sin sección clientes.
-- Actualiza la página "about" en español; si no existe, la inserta.
...
insert into public.pages (slug, locale, title, content) values
  (
    ...
    'es',
    'Bio',
    '<p>Nací en Quilmes, en el año 1976. Egresado de la Escuela Panamericana de Diseño y Publicidad. Director de <a href="https://www.sunfactoryfilms.com" target="_blank" rel="noopener">Sun Factory</a>, realizando servicios de producción audiovisual.</p>
